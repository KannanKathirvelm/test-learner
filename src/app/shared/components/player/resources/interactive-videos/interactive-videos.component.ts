...
@Component({
  selector: 'app-interactive-videos',
  templateUrl: './interactive-videos.component.html',
  styleUrls: ['./interactive-videos.component.scss'],
  animations: [collapseAnimation({ duration: 500, delay: 0 })]
})
export class InteractiveVideosComponent implements OnInit {
