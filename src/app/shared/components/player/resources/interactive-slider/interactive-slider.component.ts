...
@Component({
  selector: 'nav-interactive-slider',
  templateUrl: './interactive-slider.component.html',
  styleUrls: ['./interactive-slider.component.scss'],
  animations: [collapseAnimation({ duration: 500, delay: 0 })]
})
export class InteractiveSliderComponent implements OnInit {
  // -------------------------------------------------------------------------
  // Properties
  ...
  public isInterativeShow: boolean;
  ...
  constructor(
    ...
    this.isInterativeShow = environment.SHOW_INTERATIVE;
  }
   ...
   * This method is used to set default image if image error
   */
